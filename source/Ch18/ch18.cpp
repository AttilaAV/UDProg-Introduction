...
class My_vector {
private:
	long unsigned int sz; //meret
	double* elem; // memoria ter a free storeban
public:
	My_vector(int s): sz(s), elem{new double[s]}//konstruktor, s = elem
	{
	...
	~My_vector() { delete[] elem; } //destruktor
